...
# Justfile for universal-extension-format
...
doctor:
    @echo "Running diagnostics for universal-extension-format..."
...
tour:
    @echo "=== universal-extension-format Tour ==="
    @echo ""
...
help-me:
    @echo "=== universal-extension-format Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/universal-extension-format/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: universal-extension-format"
