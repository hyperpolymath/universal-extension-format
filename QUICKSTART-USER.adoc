...
// Replace universal-extension-format, Universal Extension Format — See README.adoc for details., just run, Universal Extension Format started successfully. with actuals
= universal-extension-format — Quick Start for Users
:toc:
:toclevels: 2

== What is universal-extension-format?

Universal Extension Format — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./universal-extension-format-portable
----
...
[source]
----
Universal Extension Format started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/universal-extension-format/wiki
