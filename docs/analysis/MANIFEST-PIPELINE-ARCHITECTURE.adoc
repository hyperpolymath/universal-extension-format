...
Use *A2ML + K9-SVC* to create a single source-of-truth that generates
multiple manifest variants for different platforms/versions.
...
[arabic]
. *fireflag-manifest.k9* - Nickel source (immediate)
...
Would you like me to: 1. Create the working K9-SVC manifest for
fireflag? 2. Add it to your Justfile? 3. Test the generation pipeline?
