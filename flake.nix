{
  description = "universal-extension-format - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 universal-extension-format development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "universal-extension-format";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P universal-extension-format.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/universal-extension-format $out/bin/  # Rust
            # cp bin/universal-extension-format $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/universal-extension-format";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-universal-extension-format" {
